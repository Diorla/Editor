...
export default (props) => {
  ...
  return (
    <Box>
      ...
      >
        <ExpansionPanelSummary expandIcon={<MdArrowDropDown />}>
          <Typography className={classes.header}>Basic</Typography>
        </ExpansionPanelSummary>
      ...
      >
        <ExpansionPanelSummary expandIcon={<MdArrowDropDown />}>
          <Typography className={classes.header}>Physical</Typography>
        </ExpansionPanelSummary>
        <ExpansionPanelDetails className={classes.expansionPanel}>
          <TextField
            label="Height"
      ...
      >
        <ExpansionPanelSummary expandIcon={<MdArrowDropDown />}>
          <Typography className={classes.header}>Story</Typography>
        </ExpansionPanelSummary>
        <ExpansionPanelDetails className={classes.expansionPanel}>
          <TextField
            label="Role"
      ...
      >
        <ExpansionPanelSummary expandIcon={<MdArrowDropDown />}>
          <Typography className={classes.header}>Background</Typography>
        </ExpansionPanelSummary>
        <ExpansionPanelDetails className={classes.expansionPanel}>
          <TextField
            label="Short term goal"
      ...
      >
        <ExpansionPanelSummary expandIcon={<MdArrowDropDown />}>
          <Typography className={classes.header}>Mannerisms</Typography>
        </ExpansionPanelSummary>
        <ExpansionPanelDetails className={classes.expansionPanel}>
          <TextField
            label="Short term goal"
      ...
      >
        <ExpansionPanelSummary expandIcon={<MdArrowDropDown />}>
          <Typography className={classes.header}>Perception</Typography>
        </ExpansionPanelSummary>
        <ExpansionPanelDetails className={classes.expansionPanel}>
          <TextField
            label="Short term goal"
      ...
      >
        <ExpansionPanelSummary expandIcon={<MdArrowDropDown />}>
          <Typography className={classes.header}>Traits</Typography>
        </ExpansionPanelSummary>
        <ExpansionPanelDetails className={classes.expansionPanel}>
          <h1>This is trait</h1>
        </ExpansionPanelDetails>
